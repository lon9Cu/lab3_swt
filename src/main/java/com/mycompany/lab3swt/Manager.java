...
public class Manager {
    ...
    public static void deleteContactId(ArrayList<Contact> lc) {
    ...
    public static Contact getContactById(ArrayList<Contact> lc, int idDelete) {
        ...
        list.add(new Contact(1,"Long Nguyen","gr1","fpt","(123)-456-7890","Long","Nguyen"));
        Manager.printAllContact(list);
